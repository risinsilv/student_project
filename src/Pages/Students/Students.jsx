...
export default function Students() {
    ...
    return (
        <>
            ...
            <Button sx={{ backgroundColor: '#F2BA1D', color: 'black', height: '50px', fontSize: '30px',paddingX:'20px', fontWeight: '700', fontFamily: 'bebas neue', border: '2px solid #F2BA1D', borderRadius: '30px', position:'fixed',bottom:'20px', left:'20px' }} ><LogoutIcon sx={{ fontSize: '35px', marginRight:'10px', marginBottom:'3px'}} />LOG OUT</Button>
        </>
